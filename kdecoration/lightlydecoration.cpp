...
K_PLUGIN_FACTORY_WITH_JSON(LightlyDecoFactory, "lightly.json", registerPlugin<Lightly::Decoration>(); registerPlugin<Lightly::Button>(QStringLiteral("button"));
...
void Decoration::paintTitleBar(QPainter *painter, const QRect &repaintRegion)
{
    ...
    if (isMaximized() || !s->isAlphaChannelSupported()) {
        ...
        QRect copy(titleRect.adjusted(isLeftEdge() ? -m_internalSettings->cornerRadius() : 0,
