...
//* nitrux style helper class.
/** contains utility functions used at multiple places in both nitrux style and nitrux window decoration */
...
public:
    ...
    QColor
    scrollBarHandleColor(const QPalette &, bool mouseOver, bool hasFocus, qreal opacity = AnimationData::OpacityInvalid, AnimationMode = AnimationNone, bool pressed = false) const;
    ...
    //* slider handle
    void renderSliderHandle(QPainter *, const QRectF &, const QColor &, const QColor &outline, bool sunken) const;
    ...
    void renderProgressBarContents(QPainter *, const QRectF &, const QColor &color) const;
    ...
    //* scrollbar handle
    void renderScrollBarHandle(QPainter *, const QRectF &, const QColor &color) const;
    ...
    void renderMauiKitTabBarTab(QPainter *, const QRectF &, const QPalette &palette, const QHash<QByteArray, bool> &stateProperties, qreal animation) const;
    ...
    {
        _borderRadius = qBound(0.0, radius, 64.0);
    }
    ...
    {
        return qMax(_borderRadius - (0.5 * penWidth) + bias, 0.0);
    }
...
private:
    ...
    qreal _borderRadius = Metrics::Frame_FrameRadius;
