...
public:
    ...
    //* button frame breeze
    void
    renderButtonFrame(QPainter *painter, const QRect &rect, const QColor &color, const QColor &outline, const QColor &shadow, bool hasFocus, bool sunken) const;
    //* button frame
    ...
    //* tab widget frame
    void renderTabWidgetFrame(QPainter *,
                              const QRect &,
                              const QColor &color,
                              Corners corners,
                              const bool windowActive,
                              Corners tabBarCorners = AllCorners,
                              const int tabBarSize = 0) const;
    ...
    void renderRoundedRectShadow(QPainter *, const QRectF &, const QColor &, qreal radius = PenWidth::Frame - 0.5) const;
