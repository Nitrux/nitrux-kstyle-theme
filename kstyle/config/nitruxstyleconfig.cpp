...
{
    return new Nitrux::StyleConfig(parent);
}
}
    ...
    : QWidget(parent)
{
    ...
    connect(_borderRadius, &QSpinBox::valueChanged, this, &StyleConfig::updateChanged);
}
...
void StyleConfig::save()
{
    ...
    StyleConfigData::setBorderRadius(_borderRadius->value());
...
void StyleConfig::updateChanged()
{
    ...
    if (_tabBarDrawCenteredTabs->isChecked() != StyleConfigData::tabBarDrawCenteredTabs()) {
        ...
        modified = true;
    } else if (_borderRadius->value() != StyleConfigData::borderRadius()) {
        modified = true;
    }
...
void StyleConfig::load()
{
    ...
    _borderRadius->setValue(StyleConfigData::borderRadius());
}
