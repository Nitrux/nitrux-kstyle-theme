...
struct Metrics {
    ...
    // shared control tracks
    static constexpr int Track_Thickness = 10;

    // progressbars
    static constexpr int ProgressBar_BusyIndicatorSize = 14;
    static constexpr int ProgressBar_Thickness = 10;
    static constexpr int ProgressBar_BusyThickness = 6;
    ...
    static constexpr int Slider_GrooveThickness = Track_Thickness;
